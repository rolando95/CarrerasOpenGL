...
public:
	...
	float spotCutOff = 45; //Angulo de dispersi�n. Valores entre [0,90] o 128.
	float spotExponent = 30; //Distribuci�n de intensidad cerca de los bordes. Valores entre [0,128]
...
public:
	...
	Si se define numero de digitos, se dibujar� ceros a la izquierda.
